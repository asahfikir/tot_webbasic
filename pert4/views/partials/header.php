...
<head>
    ...
    <title>Pertemuan 4 | Basic Web</title>
  ...
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    <div class="flex lg:flex-1">
      <a href="#" class="-m-1.5 p-1.5">
        <span class="sr-only">Rijalul Fikri</span>
    ...
    <div class="hidden lg:flex lg:gap-x-12">
      <a href="/features.php" class="text-sm font-semibold leading-6 text-gray-900">Features</a>
...
<main class="container my-7 border-t border-slate-300 p-5">
